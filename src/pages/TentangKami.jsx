                  ...
                  <div className="mx-auto max-w-screen-xl px-4 md:px-8">
                    <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
                      ...
                      <div className="md:pt-8">
                        <p className="text-center font-bold text-green-700 md:text-left">Who we are</p>
                ...
                <div className="bg-white py-2 sm:py-4 lg:py-6">
                  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    <div className="mb-10 md:mb-16">
                      <h2 className="mb-4 text-center text-3xl font-bold text-gray-800 md:mb-6 lg:text-4xl">Nilai Kami</h2>
                    </div>
                    <div className="grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16">
                      <div className="flex gap-4 md:gap-6">
                        ...
                        <div>
                          <h3 className="mb-2 text-lg font-semibold md:text-xl">Integrity</h3>
                          <p className="mb-2 text-gray-500">The quality of being honest and having strong moral principles. It involves consistency in actions, values, methods, and principles, and is often associated with trustworthiness and reliability.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-4 md:gap-6">
                        ...
                        <div>
                          <h3 className="mb-2 text-lg font-semibold md:text-xl">Niche</h3>
                          <p className="mb-2 text-gray-500">These are products or services designed to appeal to a specific segment of the market. For example, a company might produce organic, gluten-free snacks for health-conscious consumers. These products cater to a niche market rather than the mass market.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-4 md:gap-6">
                        ...
                        <div>
                          <h3 className="mb-2 text-lg font-semibold md:text-xl">Visionary</h3>
                          <p className="mb-2 text-gray-500">Forward-Thinking, Resilient and Persistent, Strategic Thinker.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-4 md:gap-6">
                        ...
                        <div>
                          <h3 className="mb-2 text-lg font-semibold md:text-xl">Sustainability</h3>
                          <p className="mb-2 text-gray-500">Consider their long-term impacts on society, the economy, and the environment.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-4 md:gap-6">
                        ...
                        <div>
                          <h3 className="mb-2 text-lg font-semibold md:text-xl">Muamalah</h3>
                          <p className="mb-2 text-gray-500">Governs financial and commercial dealings, ensuring they are conducted in a manner that is fair, transparent, and compliant with Islamic law.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-4 md:gap-6">
                        ...
                        <div>
                          <h3 className="mb-2 text-lg font-semibold md:text-xl">Amanah</h3>
                          <p className="mb-2 text-gray-500">Our key ethical concept that emphasizes integrity, honesty, and the importance of fulfilling obligations.</p>
                        </div>
                      </div>
                    </div>
                    <div className="bg-white py-12 px-4 sm:px-6 lg:px-8">
                      <div className="mx-auto max-w-screen-lg">
                        <div className="text-center mb-12">
                          <h2 className="text-3xl font-bold text-gray-800 mb-4 sm:text-4xl">Visi</h2>
                        ...
                        <div className="text-center">
                          <h2 className="text-3xl font-bold text-gray-800 mb-8 sm:text-4xl">Misi</h2>
                ...
                <section className="text-gray-600 body-font">
                  <div className="container px-5 py-5 mx-auto">
                    <div className="flex flex-col text-center w-full mb-10">
                      <h1 className="sm:text-4xl text-2xl font-bold title-font mb-4 text-gray-900">Tim Kami</h1>
                      ...
                      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                        ...
                        <br /><br />
                        Perkenalkan, kami adalah tim Invsma yang berdedikasi untuk menggabungkan keahlian kami di bidang manajemen bisnis, keuangan, teknologi, hukum Islam dan dakwah agar dapat membangun platform dan komunitas dengan harapan kami dapat berkontribusi dan bermanfaat sebagai Katalis Pertumbuhan Ekonomi Islam.
                        <br /><br />
                    ...
                    <div className="h-full flex flex-col justify-center">
                      <section className="text-gray-600 body-font">
                        <div className="container px-5 py-10 mx-auto">
                          <div className="flex flex-col text-center w-full mb-10">
                            <h1 className="sm:text-4xl text-2xl font-bold title-font mb-5 text-gray-900">Board of Directors</h1>
                          </div>
                          {/* Presiden */}
                            ...
                            <div className="p-4 md:w-1/2 lg:w-1/3">
                              <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="flex-grow">
                                  <h2 className="text-gray-900 title-font font-bold text-lg">Taleb Abdul Karem Bin Taleb</h2>
                                  <p className="text-gray-500">President Commissioner & Founder</p>
                                  <div className="mt-3 flex justify-center">
                                    <a href="#" className="text-white mx-2 flex items-center justify-center w-8 h-6 bg-green-900 rounded-full">
                                      <span className="text-xs font-bold">JKT</span>
                                    </a>
                          ...
                          <div className="flex flex-wrap justify-center -m-4">
                            <div className="p-4 md:w-1/2 lg:w-1/3">
                              <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="flex-grow">
                                  <h2 className="text-gray-900 title-font font-bold text-lg">Erly Witoyo</h2>
                          ...
                          <div className="flex flex-wrap justify-center -m-4">
                            <div className="p-4 md:w-1/2 lg:w-1/3">
                              <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="flex-grow">
                                  <h2 className="text-gray-900 title-font font-bold text-lg">Husni Muhammad Bajamal</h2>
                                  <p className="text-gray-500">Chief Executive Officer (CEO) & Founder</p>
                                  <div className="mt-3 flex justify-center">
                                    <a href="#" className="text-white mx-2 flex items-center justify-center w-8 h-6 bg-green-900 rounded-full">
                                      <span className="text-xs font-bold">JKT</span>
                                    </a>
                          ...
                          <div className="flex flex-wrap justify-center -m-4">
                            <div className="p-4 md:w-1/2 lg:w-1/3">
                              <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="flex-grow">
                                  <h2 className="text-gray-900 title-font font-bold text-lg">Hashemi Rafsanjani</h2>
                            ...
                            <div className="p-4 md:w-1/2 lg:w-1/3">
                              <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="flex-grow">
                                  <h2 className="text-gray-900 title-font font-bold text-lg">Anung Anindita</h2>
                          ...
                          <div className="flex flex-col text-center w-full mb-5 mt-16">
                            <h1 className="sm:text-4xl text-2xl font-bold title-font mb-4 text-gray-900">Board of Sharia Supervisory Candidates</h1>
                          </div>
                          <div className="flex flex-wrap justify-center -m-4">
                            <div className="p-4 md:w-1/2 lg:w-1/3">
                              <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="flex-grow">
                                  <h2 className="text-gray-900 title-font font-bold text-lg">Abdullah Alhamady</h2>
                                  <p className="text-gray-500">Senior Sharia Advisor </p>
                                  <div className="mt-3 flex justify-center">
                                    <a href="#" className="text-white mx-2 flex items-center justify-center w-8 h-6 bg-green-900 rounded-full">
                                      <span className="text-xs font-bold">JKT</span>
                                    </a>
                            ...
                            <div className="p-4 md:w-1/2 lg:w-1/3">
                              <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="flex-grow">
                                  <h2 className="text-gray-900 title-font font-bold text-lg">Ahmad Sabree</h2>
                                  <p className="text-gray-500">Sharia Compliance</p>
                                  <div className="mt-3 flex justify-center">
                                    <a href="#" className="text-white mx-2 flex items-center justify-center w-8 h-6 bg-green-900 rounded-full">
                                      <span className="text-xs font-bold">JKT</span>
                                    </a>
                          ...
                          <div className="flex flex-wrap justify-center -m-4">
                            <div className="p-4 md:w-1/2 lg:w-1/3">
                              <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="flex-grow">
                                  <h2 className="text-gray-900 title-font font-bold text-lg">Mansoor Al Wajih</h2>
                                  <p className="text-gray-500">Investor Relation</p>
                                  <div className="mt-3 flex justify-center">
                                    <a href="#" className="text-white mx-2 flex items-center justify-center w-8 h-6 bg-green-900 rounded-full">
                                      <span className="text-xs font-bold">JKT</span>
                                    </a>
                            ...
                            <div className="p-4 md:w-1/2 lg:w-1/3">
                              <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="flex-grow">
                                  <h2 className="text-gray-900 title-font font-bold text-lg">Riko Permana</h2>
                            ...
                            <div className="p-4 md:w-1/2 lg:w-1/3">
                              <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="flex-grow">
                                  <h2 className="text-gray-900 title-font font-bold text-lg">Muhammad Sidiq Abdul Aziz</h2>
                                  <p className="text-gray-500">Business Development</p>
                                  <div className="mt-3 flex justify-center">
                                    <a href="#" className="text-white mx-2 flex items-center justify-center w-8 h-6 bg-green-900 rounded-full">
                                      <span className="text-xs font-bold">JKT</span>
                                    </a>
                            ...
                            <div className="p-4 md:w-1/2 lg:w-1/3">
                              <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="flex-grow">
                                  <h2 className="text-gray-900 title-font font-bold text-lg">Muhammad Sabar</h2>
