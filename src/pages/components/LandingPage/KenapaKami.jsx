    ...
    <div className="px-4 md:px-10 border-b border-grey-500 pb-3">
      ...
      <div className="mt-[1rem] flex justify-between">
        <div className="desc w-[28rem] text-left font-semibold text-gray-500 text-lg mt-[2rem]">
          <p>
            At Invsma, we are committed to guiding you on your Sharia-compliant
            financial path with expertise, honesty, and a personalized touch.
            Our experienced team of Sharia financial consultants is dedicated to
            helping you reach your financial goals step by step.
          </p>
          <p className="mt-5">
            Our mission is to give you the knowledge and tools to make informed
            decisions while staying true to Sharia principles, ensuring your
        ...
        <div className="flex flex-col w-[22rem]">
          ...
          <div className="TAM border-b border-gray-400 pb-[2rem] mt-[2rem] mr-[8rem] w-[15rem]">
            ...
            <p className="font-light textleft">Serviceable Available Market</p>
          </div>
          <div className="TAM border-b border-gray-400 pb-[2rem] mt-[2rem] mr-[14rem] w-[18rem]">
            ...
            <p className="font-light textleft">Serviceable Obtainable Market</p>
          </div>
        </div>
      </div>
    </div>
