      ...
      <div className="flex items-center px-12 py-2 lg:px-18 xl:px-10 max-lg:py-4">
        ...
        <nav className="fixed top-[5rem] left-0 px-5 bottom-0 right-0 pl-[6rem] lg:static lg:flex lg:mx-auto">
          <div className="relative z-2 flex flex-col items-center justify-center m-auto lg:flex-row">
            ...
            <a
              href="https://invsma.co.id/"
              className="relative text-color-1 font-extrabold block text-2xl group transition-color px-3 py-3 md:py-4 lg:mb lg:-mr-0.25 lg:text-[1rem] lg:font-semibold lg:leading-5 xl:px-8"
            >
              Home
